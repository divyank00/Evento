package com.example.collegeproject.base.ticket.past;
 ...
 * Use the {@link PastTicketFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PastTicketFragment extends Fragment implements Adapter.itemClick {
    ...
    public static PastTicketFragment newInstance() {
        return new PastTicketFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_past_ticket, container, false);
        ...
        shimmerRecyclerView = v.findViewById(R.id.pastTickets);
    ...
    private void fetchData() {
        ...
        getBookedEventsViewModel.getBookedPastData()
