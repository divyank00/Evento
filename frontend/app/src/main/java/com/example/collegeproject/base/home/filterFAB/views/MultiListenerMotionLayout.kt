package com.example.collegeproject.base.home.filterFAB.filter.views
...
//        if (currentState == transitionId) return
    ...
    fun removeTransitionListener1(listener: TransitionListener) {
        listeners.remove(listener)
    }

    @Deprecated(message = "Use addTransitionListener instead", replaceWith = ReplaceWith(
            "addTransitionListener(listener)",
            "com.example.collegeproject.base.Home.views.MultiListenerMotionLayout.addTransitionListener"
    ))
