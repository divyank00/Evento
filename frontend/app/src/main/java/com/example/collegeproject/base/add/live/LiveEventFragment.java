 ...
 */
public class LiveEventFragment extends Fragment implements Adapter.itemClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_live_event, container, false);
        ...
        shimmerRecyclerView = v.findViewById(R.id.liveEvents);
    ...
    private void fetchData() {
        ...
        getRegisteredEventsViewModel.getRegisteredLiveData()
